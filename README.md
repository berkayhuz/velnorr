<div align="center">
  ...
  <p>
    <a href="https://github.com/berkayhuz/velnorr/releases/download/v1.0.2/Velnorr-1.0.2.dmg">
...
Open `dist/Velnorr-1.0.2.dmg`, then drag `Velnorr.app` into `Applications`.
...
`Packaging/build_dmg.sh` creates a self-contained `Velnorr.app`, copies the SwiftPM resource bundle and localization directories into the app bundle, signs it with an available local identity (or ad-hoc signing), and creates `dist/Velnorr-1.0.2.dmg`.
