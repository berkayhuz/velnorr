...
The generated file is `dist/Velnorr-1.0.2.dmg`. Open it, drag
...
```sh
xcrun notarytool submit dist/Velnorr-1.0.2.dmg \
  --keychain-profile "YOUR_NOTARY_PROFILE" --wait
xcrun stapler staple dist/Velnorr-1.0.2.dmg
xcrun stapler validate dist/Velnorr-1.0.2.dmg
